...
set(gca,'Position',[0.159022613525391 0.129047619047619 0.80097738647461 0.817736018952871]);
hold on
...
right_para = [a0,cont_para(pos_right_u_star),];
...
plot3(right_para,Node_pos*ones(size(right_para)),right_unode,'Marker','none',...
    'LineWidth',gwlinewidth,'LineStyle','-','Color','k');
plot3(left_para(1:2:end),Node_pos*ones(size(left_para(1:2:end))),left_unode(1:2:end),'Marker','none',...
    'LineWidth',gwlinewidth,'LineStyle','--','Color','k');
