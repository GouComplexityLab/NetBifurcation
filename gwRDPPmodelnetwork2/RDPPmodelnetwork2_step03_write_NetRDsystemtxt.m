...
filename = [results_path  'RDPPSystemOnNetwork2.txt'];
fid = fopen(filename, 'w');

fprintf(fid, '%s\n', ['RDPPSystemOnNetwork2']);
fprintf(fid, '%s\n','');
...
fprintf(fid, '%s\n',['function dx = RDPPSystemOnNetwork2(x, N, a, b, c, d1, d2)']);
fprintf(fid, '%s\n','');
...
fprintf(fid, '%s\n',['function F = RDPPSystemOnNetwork2(x, a, b, c, d1, d2)']);
fprintf(fid, '%s\n','');
