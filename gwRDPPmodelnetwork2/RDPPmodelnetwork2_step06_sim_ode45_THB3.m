...
% % Initial condition 
init_n = 1;
Initial_U = u_star*ones(size(x)) + 0.005 * ones(size(x)) + 0.0001 * special_eigenvector';
Initial_V = v_star*ones(size(x)) + 0.005 * ones(size(x)) + 0.0001 * special_eigenvector';
...
% % Initial condition
% init_n = 3;
% Initial_U = u_star*ones(size(x)) + 0.014 * ones(size(x)) + 0.0001 * special_eigenvector';
% Initial_V = v_star*ones(size(x)) + 0.014 * ones(size(x)) + 0.0001 * special_eigenvector';
