...
mu_up_right = linspace(-maxmu,0,1000);
...
mu_down_right = linspace(-maxmu,0,1000);
...
figure_name = [results_path 'Figure Step02 SSBNF diagram wsnetworks_n=10k=2p=0.05number=796.eps'];
