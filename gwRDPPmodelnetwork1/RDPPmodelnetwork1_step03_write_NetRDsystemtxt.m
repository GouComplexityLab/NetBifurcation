...
filename = [results_path  'RDPPSystemOnNetwork1.txt'];
fid = fopen(filename, 'w');

fprintf(fid, '%s\n', ['RDPPSystemOnNetwork1']);
fprintf(fid, '%s\n','');
...
fprintf(fid, '%s\n',['function dx = RDPPSystemOnNetwork1(x, N, a, b, c, d1, d2)']);
fprintf(fid, '%s\n','');
...
fprintf(fid, '%s\n',['function F = RDPPSystemOnNetwork1(x, a, b, c, d1, d2)']);
fprintf(fid, '%s\n','');
