...
h3 = fimplicit(f3,[0 mu1_right mu2_left mu2_right],'-m','LineWidth',gwLineWidth);
...
hold on
fimplicit(f1,[mu1_left mu1_right mu2_left mu2_right],'-g','LineWidth',gwLineWidth)
fimplicit(f2,[mu1_left mu1_right mu2_left mu2_right],'-b','LineWidth',gwLineWidth)
fimplicit(f3,[0 mu1_right mu2_left mu2_right],'-m','LineWidth',gwLineWidth)
fimplicit(f4,[mu1_left 0 mu2_left mu2_right],'-r','LineWidth',gwLineWidth)
...
xlim([0.0482952425193776 0.0518942728673947]);
ylim([0.0453216996933388 0.0503945138269935]);
...
xlim([-0.0512621545516068 -0.0486284096956398]);
ylim([-0.0491119231505803 -0.0464781782946132]);
