...
[t,y]=ode45(hls{2},[0:0.1:25e4],x0,options, a, b_first, c, d1, d2);
...
ylim([0.0426039709180482 0.0510169126075046]);
...
[x0,v0]=init_EP_EP(@RDPPSystemOnNetwork3,initial_x0,p,ap);
opt=contset;
...
opt=contset(opt,'MaxStepsize',MaxStepsize_);
opt=contset(opt,'MaxNumPoints',3000);
opt=contset(opt,'InitStepsize',0.0000001);
opt=contset(opt,'TSearchOrder',1);
